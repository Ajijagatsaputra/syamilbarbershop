...
import { Eye, EyeOff, Mail, Lock, Scissors, ArrowLeft } from 'lucide-react';
        ...
        <div className="bg-neutral-800 rounded-2xl shadow-2xl p-8 md:p-10 border-2 border-amber-500/30 relative overflow-hidden">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="relative group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Mail className="h-5 w-5 text-neutral-500 group-focus-within:text-amber-500 transition-colors" />
                </div>
                <input
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  className="w-full pl-12 pr-4 py-3 bg-neutral-700 border-2 border-neutral-600 rounded-lg focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 outline-none transition-all duration-300 text-white placeholder-neutral-500"
            ...
            <div className="relative group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Lock className="h-5 w-5 text-neutral-500 group-focus-within:text-amber-500 transition-colors" />
                </div>
                <input
                  type={showPassword ? 'text' : 'password'}
                  value={password}
                  onChange={(e) => setPassword(e.target.value)}
                  className="w-full pl-12 pr-12 py-3 bg-neutral-700 border-2 border-neutral-600 rounded-lg focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 outline-none transition-all duration-300 text-white placeholder-neutral-500"
                  placeholder="••••••••"
                  required
                />
                <button
